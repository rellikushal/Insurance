            ...
            <div className="card">
              ...
              <div>
                  ...
                  <input 
                    ...
                    name='price' 
                    disabled={vprice} 
                    value={price ? price : vprice}
                    onKeyPress={(e) => {
                      const isValidInput = /^[1-9][0-9]{0,5}$/;
                      if (!isValidInput.test(e.target.value + e.key) && e.key !== 'Backspace') {
                        e.preventDefault();
                      }
                    }} 
                    onChange={(e) => {
                      ...
                      if (value === '' || value === '0') {
                        setError('The vehicle price cannot be zero.');
                      } else {
                        setError('');
                      }
                      change(e);
                ...
                <button type="button" className="btn btn-primary" disabled={!price} onClick={buttonClick}>Save</button>
              </div>
            </div>
          </div>
