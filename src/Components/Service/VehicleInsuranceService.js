...
gm
    ...
    static addNotificationForEmail(data){
        const INSURANCE_API_BASE_URL = url+"/notification/addForEmail";
        return axios.post(INSURANCE_API_BASE_URL,data);
    }

    static addNotificationForMobile(data){
        const INSURANCE_API_BASE_URL = url+"/notification/addForMobile";
        return axios.post(INSURANCE_API_BASE_URL,data);
    }
    ...
    static getPolocyDetails(){
        const INSURANCE_API_BASE_URL = url+"/payment/fetch";
        return axios.get(INSURANCE_API_BASE_URL);
    }

    static getCustomerDetails(){
        const INSURANCE_API_BASE_URL = url+"/customer/fetch";
        return axios.get(INSURANCE_API_BASE_URL);
    }
    ...
    static getAllDetailsOfMobile(){
        const INSURANCE_API_BASE_URL = url+"/notification/fetchAllMobile";
        return axios.get(INSURANCE_API_BASE_URL);
    }

    static getAllDetailsOfEmail(){
        const INSURANCE_API_BASE_URL = url+"/notification/fetchAllEmail";
        return axios.get(INSURANCE_API_BASE_URL);
    }

    static getAllDetailsOfMobileFindByCustomerId(customerId)
    {
        const INSURANCE_API_BASE_URL = url+"/notification/getAllMobile/"+customerId;
        return axios.get(INSURANCE_API_BASE_URL);
    }
    static getAllDetailsofEmailFindByCustomerId(customerId)
    {
        const INSURANCE_API_BASE_URL = url+"/notification/getAllEmail/"+customerId;
        return axios.get(INSURANCE_API_BASE_URL);
    }

    static upDateStatusForEmail(customerId,data)
    {
        const INSURANCE_API_BASE_URL = url+"/notification/updateEmail/";
        return axios.put(INSURANCE_API_BASE_URL+customerId,data);
    }
    static upDateStatusForMobile(customerId,data)
    {
        const INSURANCE_API_BASE_URL = url+"/notification/updateMobile/";
        return axios.put(INSURANCE_API_BASE_URL+customerId,data);
    }
